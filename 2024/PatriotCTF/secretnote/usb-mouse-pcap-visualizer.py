...
def main():
    ...
    for snapshot in snapshot_mouse(args.input_file):
        mt.add(snapshot)
    print(f"{len(mt.snapshots)} snapshots loaded")
    mt.save(args.output_file)
    print(f"mouse snapshots saved to {args.output_file}")
    print("visualize the data by opening the assets/index.html file in your browser.")
