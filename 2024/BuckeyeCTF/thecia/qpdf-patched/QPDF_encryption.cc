...
QPDF::initializeEncryption()
{
    ...
    if (this->m->provided_password.substr(0, 4) == "key:")
    {
//        std::cout << "Provided key: " << this->m->provided_password.substr(4) << std::endl;
        Hex2ascii(this->m->provided_password.substr(4), this->m->encryption_key);
    }
    else
    {
